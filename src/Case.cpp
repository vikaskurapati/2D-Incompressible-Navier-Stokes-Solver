...
Case::Case(std::string file_name, int argn, char **args, int my_rank) {
    ...
    output_log(_datfile_name, nu, UI, VI, PI, GX, GY, xlength, ylength, dt, imax, jmax, gamma, 
                                omg, tau, itermax, eps, TI, alpha, beta, num_walls, Tc, Th, my_rank);
}
...
void Case::output_log( std::string dat_file_name, double nu, double UI, double VI, double PI, 
