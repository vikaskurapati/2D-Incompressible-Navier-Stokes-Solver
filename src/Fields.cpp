...
void Fields::calculate_fluxes(Grid &grid) {std::cout << "Fluxes Calculated" << std::endl;}

void Fields::calculate_rs(Grid &grid) {std::cout << "Right hand side Calculated" << std::endl;}
