...
class Fields {
  public:
     ...
     *
     */
    Fields(Grid& grid, double _nu, double _dt, double _tau, double _alpha, double _beta, std::string energy_eq, int imax, int jmax, double UI, double VI, double PI, double TI);
